...
dataset = "Sprintboard Fuji" # Enter the name or ID of the semantic model
workspace = "Operationeel dashboard v2.0" # Enter the workspace name or ID in which the semantic model exists
